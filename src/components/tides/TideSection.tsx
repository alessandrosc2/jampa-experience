...
interface TideSectionProps {
  onOpenPlacesPreview?: () => void;
}

export const TideSection: React.FC<TideSectionProps> = ({ onOpenPlacesPreview }) => {
  ...
  return (
    <section className="tide-section-wrapper" id="mares">
      <div className="container">
        {/* Header da Seção */}
        <div className="tide-header-box">
          <div className="tide-section-pill">
            <Waves size={15} color="#00B4D8" />
            <span>PREVISÃO OFICIAL DE MARÉS • JOÃO PESSOA - PB</span>
          </div>

          <h2 className="tide-main-title">
            Tábua de Marés & <span className="text-cyan">Piscinas Naturais</span>
          </h2>

          <p className="tide-subtext">
            O segredo número #1 dos nativos: as piscinas de Picãozinho, Seixas e Areia Vermelha só aparecem na <strong>maré baixa (seca)</strong>. Planeje seus passeios com precisão astronômica para os próximos 7 dias.
          </p>

          {/* Status em Tempo Real */}
          {forecast?.currentStatus && (
            <div className="tide-live-status-badge glass-panel">
        ...
        {/* Loading State */}
        {isLoading && !forecast && (
          <div className="tide-loading-box glass-panel">
        ...
        {forecast && selectedDay && (
          <div className="tide-dashboard-card glass-panel">
            {/* Seletor Horizontal de 7 Dias (Hoje + 6 dias) */}
            ...
            <div className="tide-day-details-wrap">
              ...
              {/* Grid dos Horários de Maré do Dia (Picos e Fundos) */}
                    ...
                    >
                      <div className="tide-card-header">
                        <span className="tide-type-tag">
                          {h.type === 'low' ? (
                            <>
                              <ArrowDown size={14} color="#00B4D8" /> MARÉ BAIXA (SECA)
                            </>
                          ) : (
                            <>
                              <ArrowUp size={14} color="#F4A261" /> MARÉ ALTA (CHEIA)
                            </>
                          )}
                        </span>
                        {isMinTide && (
              ...
              <div className="tide-tourist-tips-box glass-panel">
                <div className="tourist-tips-header">
                  <Compass size={18} color="#00B4D8" />
                ...
                <div className="tips-columns-grid">
                  ...
                  <div className="tip-col-card">
                    ...
                    <span className="tip-col-val">
                      Use sapatilha de neoprene nos recifes de corais e não pise sobre os corais vivos.
                    </span>
                  </div>
                </div>
              </div>

              {/* Botões de Ação & Link Oficial tabuademares.com */}
              <div className="tide-actions-footer">
                <div className="tide-footer-left">
                  <span className="station-info">
                    📍 Estação de Referência: <strong>Porto de Cabedelo / João Pessoa - PB</strong> (Marinha do Brasil / DHN)
                  </span>
                </div>
                ...
                <div className="tide-footer-buttons">
                  ...
                  >
                    <span>Ver Previsão Completa no TábuaDeMarés.com</span>
      ...
      <style>{`
        ...
        .status-trend.baixando {
          color: #00B4D8;
        }

        .status-trend.subindo {
          color: #F4A261;
        }
        ...
        /* Box Informativo de Recomendações */
